                        ...
                        <div class="col-xl-6 col-lg-4">
                            <div class="text-center">
                                <div id="news-flash" class="d-inline-block">
                                    <ul>
                                        <li>Get great devices up to 50% off <a href="{{ route('shop') }}" wire:navigate>View details</a></li>
                                        <li>Supper Value Deals - Save more with coupons</li>
                                        <li>Trendy 25silver jewelry, save up 35% off today <a href="{{ route('shop') }}" wire:navigate>Shop now</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="header-info header-info-right">
                                <ul>                 
                                    ...
                                    <li>
                                        ...
                                        @else
                                        <i class="fi-rs-key"></i>
                                        <a href="{{ route('login') }}">Log In </a> @if (Route::has('register')) / <a href="{{ route('register') }}">Sign Up</a>@endif
                                        @endauth
                                    </li>
                                    @endif
                                </ul>
                    ...
                    <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="header-nav d-none d-lg-flex">
                            ...
                            <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                <nav>
                                    <ul>
                                        <li><a class="{{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}" wire:navigate>Home </a></li>
                ...
                <div class="mobile-header-content-area">
                    ...
                    <div class="mobile-menu-wrap mobile-header-border">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{ route('home') }}" wire:navigate>Home</a></li>
                                <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{ route('shop') }}" wire:navigate>shop</a></li>
                    ...
                    <div class="mobile-header-info-wrap mobile-header-border">
                        ...
                        <div class="single-mobile-header-info">
                            <a href="#" onclick="document.getElementById('logout-form2').submit();">Log Out </a>                        
                        </div>
                        @else
                        <div class="single-mobile-header-info">
