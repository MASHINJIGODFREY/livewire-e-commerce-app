                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            <span class="save-price  font-md color3 ml-15">{{ $product->discount_percentage }}% Off</span>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-60">
                            ...
                            <div class="col-12">
                                <div class="row related-products">
                                    @foreach($related as $key => $related_item)
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{ route('product', ['id' => $related_item->id]) }}" tabindex="0" wire:navigate>
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{ route('product', ['id' => $related_item->id]) }}" tabindex="0" wire:navigate>{{ $related_item->name }}</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                    </span>
                                                </div>
                                                <div class="product-price">
                                                    <span>${{ $related_item->sale_price }}</span>
                                                    <span class="old-price">${{ $related_item->regular_price }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
