                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="tab-content dashboard-content">
                                <div class="tab-pane fade active show" id="delete-account" role="tabpanel" aria-labelledby="delete-account-tab">
                                    <div class="card">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="submit" class="btn btn-fill-out submit" name="submit" value="Submit">
                                                            ...
                                                            <span wire:loading wire:target="deleteUser">&#8987; Processing...</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
